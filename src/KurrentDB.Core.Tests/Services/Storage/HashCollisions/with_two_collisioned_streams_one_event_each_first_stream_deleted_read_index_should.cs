...
namespace KurrentDB.Core.Tests.Services.Storage.HashCollisions;
...
public class
	...
	public async Task return_correct_last_event_version_for_first_stream() {
		Assert.AreEqual(EventNumber.DeletedStream, await ReadIndex.GetStreamLastEventNumber("AB", CancellationToken.None));
	}
