...
partial class EventRecord {
	...
	public EventRecord(KurrentDB.Core.Data.EventRecord eventRecord) {
		if (eventRecord == null)
			return;
		AssignValues(
	...
	public EventRecord(KurrentDB.Core.Data.EventRecord eventRecord, long eventNumber) {
		if (eventRecord == null)
			return;
		AssignValues(
			eventRecord.EventStreamId,
...
partial class ResolvedIndexedEvent {
	...
	public ResolvedIndexedEvent(KurrentDB.Core.Data.EventRecord @event, KurrentDB.Core.Data.EventRecord link) {
		if (@event != null)
...
partial class ResolvedEvent {
	...
	public ResolvedEvent(KurrentDB.Core.Data.ResolvedEvent pair)
