...
// using static KurrentDB.SchemaRegistry.ListSchemaVersionsRequestValidator;
//
// namespace KurrentDB.SchemaRegistry.Tests.Queries.Validators;
//
// public class ListSchemaVersionsRequestValidatorTests {
//     [Test]
//     public void validate_with_valid_name_should_be_valid() {
//         var request = new ListSchemaVersionsRequest {
...
//         result.Errors.Should().Contain(v => v.PropertyName == nameof(ListSchemaVersionsRequest.SchemaName));
//     }
//
